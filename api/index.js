...
// ==========================================
// KODE INJEKSI: POPUP ELEGAN + WIDGET KACA
// ==========================================
const injectedHTML = `
<style>
  /* ==========================================
     STYLING POPUP (GLASSMORPHISM)
     ========================================== */
  .welcome-overlay {
    ...
    opacity: 1; transition: opacity 0.6s ease; font-family: 'Segoe UI', system-ui, sans-serif;
  }
  .welcome-card {
    background: rgba(30, 30, 30, 0.4); border: 1px solid rgba(255, 255, 255, 0.1);
    padding: 45px 35px; border-radius: 24px; text-align: center; color: white;
    max-width: 380px; width: 90%; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5);
    transform: translateY(0); transition: transform 0.6s ease;
  }
  .welcome-overlay.hide { opacity: 0; pointer-events: none; }
  .welcome-overlay.hide .welcome-card { transform: translateY(30px); }
  
  .welcome-icon { font-size: 32px; margin-bottom: 20px; text-shadow: 0 0 15px rgba(255,255,255,0.3); }
  ...
  .welcome-btn {
    background: linear-gradient(135deg, #ffffff, #d4d4d4); color: #121212;
    border: none; padding: 14px 40px; border-radius: 30px; font-size: 15px; font-weight: 600;
    cursor: pointer; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(255, 255, 255, 0.15);
  }
  .welcome-btn:hover { transform: scale(1.05); box-shadow: 0 6px 20px rgba(255, 255, 255, 0.25); }

  /* ==========================================
     STYLING FLOATING WIDGET (FULL GLASSMORPHISM)
     ========================================== */
  ...
  /* Efek Kaca untuk Semua Tombol Bulat */
  .fab-btn { 
    width: 50px; height: 50px; border-radius: 50%; display: flex; justify-content: center; align-items: center; 
    text-decoration: none; color: white; cursor: pointer; padding: 0;
    transition: transform 0.2s, box-shadow 0.2s, background 0.2s; 
    
    /* Inti dari Glassmorphism */
    background: rgba(255, 255, 255, 0.05);
    backdrop-filter: blur(10px); 
    -webkit-backdrop-filter: blur(10px);
    border: 1px solid rgba(255, 255, 255, 0.15); /* Pantulan pinggir kaca */
  ...
  /* Rona Warna Tipis untuk Identitas Kaca */
  .fab-main { 
    background: rgba(40, 40, 40, 0.6); /* Kaca Hitam Transparan */
    width: 60px; height: 60px; font-size: 28px; z-index: 2; 
  }
  .fab-tg { background: rgba(44, 165, 224, 0.25); } /* Kaca rona Biru Telegram */
  .fab-dc { background: rgba(88, 101, 242, 0.25); } /* Kaca rona Ungu Discord */
  .fab-music { background: rgba(255, 51, 102, 0.25); } /* Kaca rona Merah Muda Musik */
</style>

<audio id="bgMusic" loop>
  <source src="MASUKKAN_LINK_MP3_LANGSUNG_DISINI" type="audio/mpeg">
</audio>
...
<div class="fab-container">
  <div class="fab-options" id="fabOptions">
    <div class="fab-btn fab-music" onclick="toggleMusic()" title="Play/Pause Music">
